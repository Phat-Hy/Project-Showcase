        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pitch = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationLockouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationLockouts_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationLockouts_Users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationLockouts_JobId",
                table: "ApplicationLockouts",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationLockouts_StudentId_JobId",
                table: "ApplicationLockouts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_LastUpdatedAt_Status",
                table: "Projects",
                columns: new[] { "LastUpdatedAt", "Status" });
