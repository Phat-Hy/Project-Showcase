...
namespace GaraShowcase.Api.Data
{
    public static class DbInitializer
    {
        public static void Initialize(GaraDbContext context)
        {
            ...
            // Clear existing seed data to force refresh with real team members
            ...
            // 2. Seed Users & Team Placements (Using Real Team Members)
            var users = new User[]
            {
                ...
                // Founder Trịnh Hải Đức (owns EduLink Platform)
                new User
                {
                ...
                // Student Job Seeker Lê Tuấn Khanh (Ready to test applying to jobs)
                new User
                {
