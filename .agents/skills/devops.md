...
- `.agents/skills/references/azure-terraform-iac.md` - interactive 6-phase Azure Terraform
...
- `.agents/skills/references/github-actions-cicd.md` - interactive 6-phase shift-left
